...
class Modal extends Component {
    ...
    render() {
        ...
        if (this.state.InOutCode === "収入") {
            InOutChoice =
                <div aria-label="DivisionCode" className="btn-group3" name="DivisionCode" value={this.props.DivisionCode} onChange={this.DataChangeHandler}>
            ...
            return (
                <div className="modal-main-frame">
                    ...
                    <div className="modal-frame">
                        ...
                        <div className="btn-group1" name="InOutCode" value={this.state.InOutCode} onChange={this.DataChangeHandler}>
                            <ButtonToolbar>
